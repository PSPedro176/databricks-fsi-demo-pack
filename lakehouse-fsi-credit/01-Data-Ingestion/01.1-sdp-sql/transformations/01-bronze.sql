...
FROM STREAM read_files(
  '/Volumes/${bundle.catalog}/${bundle.schema}/${bundle.volume}/credit_bureau',
  format => 'json',
...
SELECT *
FROM STREAM read_files(
  '/Volumes/${bundle.catalog}/${bundle.schema}/${bundle.volume}/internalbanking/customer',
  format => 'csv',
  header => true,
  inferSchema => true,
  inferColumnTypes => true,
...
SELECT *
FROM STREAM read_files(
  '/Volumes/${bundle.catalog}/${bundle.schema}/${bundle.volume}/internalbanking/relationship',
  format => 'csv',
  header => true,
  inferSchema => true,
  inferColumnTypes => true
...
SELECT *
FROM STREAM read_files(
  '/Volumes/${bundle.catalog}/${bundle.schema}/${bundle.volume}/internalbanking/account',
  format => 'csv',
  header => true,
  inferSchema => true,
  inferColumnTypes => true
...
SELECT *
FROM STREAM read_files(
  '/Volumes/${bundle.catalog}/${bundle.schema}/${bundle.volume}/fund_trans',
  format => 'json',
  inferColumnTypes => true
);
...
SELECT *
FROM STREAM read_files(
  '/Volumes/${bundle.catalog}/${bundle.schema}/${bundle.volume}/telco',
  format => 'json',
  inferColumnTypes => true
);